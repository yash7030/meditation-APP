...
class PlayingSoundViewState extends State<PlayingSoundView> {
  // Color activeColor = Color(0xFF41CFBD).withOpacity(0.8);
  // Color volumeColor = Color(0xFF41CFBD);
  ...
  void initState() {
    super.initState();
    // volumeColor = Color(0xFF41CFBD).withOpacity(0.8);
  ...
  Widget volumeSlider() {
    ...
    return SliderTheme(
      data: SliderTheme.of(context).copyWith(
        ...
        inactiveTrackColor: volumeColor.withOpacity(0.8),
